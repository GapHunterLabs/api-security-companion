package dev.gaphunter.apisecuritycompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.apisecuritycompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.apisecuritycompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "API Security Companion"
    ...
    // https://plugins.jetbrains.com/plugin/<id>-api-security-companion/reviews once the
